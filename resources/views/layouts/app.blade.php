  ...
  <aside class="main-sidebar sidebar-dark-success elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex justify-content-center">
        <div class="image">
          <img src="{{ asset('dist/img/avatar3.png')}}" class="img-circle elevation-2" style="width: 100px; height: 100px;" alt="User Image">
        </div>
      </div>
      <div class="user-panel mt-3 pb-3 mb-3 d-flex justify-content-center">
        <div class="image">
